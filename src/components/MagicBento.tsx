...
const DEFAULT_SPOTLIGHT_RADIUS = 330;
const DEFAULT_GLOW_COLOR = '132, 0, 255';
const MOBILE_BREAKPOINT = 768;

const defaultSampleCards: BentoCardItem[] = [
  {
    id: 'analytics',
    color: '#120F17',
    title: 'Analytics',
  ...
  },
  {
    ...
    color: '#120F17',
    title: 'Dashboard',
    description: 'Centralized data overview',
    label: 'Overview',
    icon: 'dashboard',
    actionText: 'VIEW'
  },
  ...
  },
  {
    ...
    color: '#120F17',
    title: 'Integration',
    description: 'Connect your favorite development tools',
    label: 'Connectivity',
    icon: 'hub',
    actionText: 'LINK'
  },
  {
    ...
    color: '#120F17',
    title: 'Security',
    description: 'Enterprise-grade identity protection',
    label: 'Protection',
    icon: 'security',
    actionText: 'PROTECT'
  }
...
const BentoCardGrid: React.FC<{
  ...
  <div className={`card-grid bento-section ${count ? `cards-count-${count}` : ''}`} ref={gridRef}>
    {children}
  </div>
);
...
const MagicBento: React.FC<MagicBentoProps> = ({
  ...
  const cardsToRender = cards || (children ? null : defaultSampleCards);
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <BentoCardGrid gridRef={gridRef} count={cardsToRender?.length}>
        {children ? (
          children
        ) : (
